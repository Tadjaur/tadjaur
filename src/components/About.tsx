...
import { getTotalProjectsCount, portfolioData } from "../data/portfolioData";

gsap.registerPlugin(ScrollTrigger);

export default function About() {
	const sectionRef = useRef<HTMLElement>(null);
	const { personalInfo, experiences, education, certifications } =
		portfolioData;
							...
							<CardBody className="p-8">
								...
								<div className="space-y-4 text-gray-300 leading-relaxed">
									<p>
										...
										based in {personalInfo.location}, with a passion for
								...
								<CardBody className="p-8">
									...
									<div className="space-y-4">
										{certifications.map((cert, index) => (
											<div
												key={index}
												className="flex items-start gap-4 p-4 rounded-lg bg-content2/50"
											>
												...
												<div>
													{cert.link ? (
														<h4 className="font-semibold text-white underline">
															<a
																href={cert.link}
																target="_blank"
