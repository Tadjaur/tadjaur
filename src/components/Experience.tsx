				...
				<div className="relative max-w-5xl mx-auto">
					...
					{experiences.map((exp, index) => (
						...
						>
							...
							{/* Card */}
							<Card
								className={`glass border-none card-hover ${index % 2 === 0 ? "md:mr-8" : "md:ml-8"}`}
							>
								<CardBody className="p-6">
									...
									>
										<ul
											className={`space-y-2 text-gray-300 text-sm ${index % 2 === 0 ? "md:list-none" : "list-disc list-inside"}`}
										>
									...
									{exp.achievements.length > 0 && (
										...
										>
											...
											<ul
												className={`space-y-1 text-gray-400 text-xs ${index % 2 === 0 ? "md:list-none" : "list-disc list-inside"}`}
											>
									...
									{exp.projects.length > 0 && (
										<div
											className={`mt-4 pt-4 border-t border-content3 ${index % 2 === 0 ? "md:text-right" : ""}`}
										>
											<p className="text-xs text-gray-500 uppercase tracking-wider mb-2">
