			...
			<div className="container mx-auto px-6">
				...
				<div className="text-center mb-16">
					...
					<p className="text-gray-400 max-w-2xl mx-auto">
						{personalInfo.totalYearsExperience}+ years of experience with modern
							...
							<div key={skill.name} className="space-y-2">
								...
								<div className="skill-bar">
									<div
										...
										style={{
											width: `${(skill.years / personalInfo.totalYearsExperience) * 100}%`,
										}}
									/>
								</div>
							</div>
				...
				<div className="skills-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6">
					{Object.entries(skillCategories).map(([category, skills]) => {
						...
						return (
							<Card
								key={category}
								className="skill-category glass border-none card-hover"
							>
