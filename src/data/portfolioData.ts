...
const experiences: Experience[] = [
	...
	{
		title: "AI/Fullstack Developer & Collaborator",
		company: "Nelson Assist (Freelance/Team Collaboration)",
		startDate: "September 2025",
		endDate: "December 2025",
		duration: "3 months",
		description: [
			"Co-developed NelsonBot a configurable voice assistant platform designed to act as a real-time call assistant, enabling users to interact via voice commands and automate workflows using integrated tools like Zapier and Calendly.",
			"Built the assistant using the Vercel AI SDK, focusing on seamless voice interaction and customizable responses without relying on traditional NLP frameworks.",
			"Implemented text-to-speech (TTS) capabilities using Eleven Labs and Twilio’s default voices, ensuring natural and high-quality voice interactions for users.",
			"Collaborated with a team to design a multi-channel assistant (direct voice calls, web interface) with a roadmap to expand to WhatsApp, prioritizing ease of configuration and user-friendly experiences.",
			"Integrated MCP (Multi-Channel Platform) access to third-party tools such as Zapier (for workflow automation) and Calendly (for scheduling), enabling users to manage tasks and appointments directly through the assistant.",
		],
		achievements: [
			"Successfully deployed a publicly accessible voice assistant at [newtest.nelsonassist.bot](https://newtest.nelsonassist.bot/), demonstrating its ability to handle real-time voice interactions and tool integrations.",
			"Created a fully configurable call assistant, allowing users to customize voice responses, workflows, and tool integrations to fit their specific needs.",
			"Enabled seamless integration with Zapier and Calendly, empowering users to automate scheduling and workflows directly through voice commands.",
			"Optimized the assistant’s architecture for low-latency voice interactions, ensuring smooth and responsive user experiences.",
		],
		technologies: [
			"Vercel AI SDK",
			"Eleven Labs (TTS)",
			...
			"Web APIs",
			"Git",
			"Multi-Channel Platform (MCP) Integration",
		],
		projects: [
			{
				name: "NelsonBot: Configurable Voice Assistant",
				description:
					"A configurable voice assistant designed to act as a real-time call assistant, enabling users to interact via voice commands and automate workflows using integrated tools like Zapier and Calendly. Built with the Vercel AI SDK, Eleven Labs/Twilio for TTS, and a focus on multi-channel accessibility (voice, web, and future WhatsApp integration).",
				technologies: [
					"Vercel AI SDK",
					"Eleven Labs",
					"Twilio",
				...
				link: "https://newtest.nelsonassist.bot/",
			},
		],
	},
	{
